...
public class GthPersona implements Serializable {
    ...
    public GthPersona(PersonaDTO dto) {
        this.perCodigo = dto.codigo();
        this.perNroIdentificacion = dto.numeroIdentificacion();
        this.perApellidos = dto.perApellidos();
        this.perNombres = dto.perNombres();
        this.perGenero = dto.perGenero();
        this.perFechaNacimiento = dto.fechaNacimiento();
        this.perCallePrincipal = dto.callePrincipal();
        this.perNroCasa = dto.numeroCasa();
    }
